    ...
    for (( i=0; i<filled; i++ )); do
        ...
        if (( custom )); then
            ...
            case "$mode" in
                ...
                bubblegum|candy)
                    r=$(( 255 + (220 - 255) * t / 1000 ))
                    g=$(( 110 + (160 - 110) * t / 1000 ))
                    b=$(( 180 + (240 - 180) * t / 1000 ))
                    ;;
                aurora)
                    r=$(( 0   + (80  - 0)   * t / 1000 ))
                    g=$(( 245 + (210 - 245) * t / 1000 ))
                    b=$(( 180 + (110 - 180) * t / 1000 ))
                    ;;
                peach|peaches)
                    r=$(( 255 + (255 - 255) * t / 1000 ))
                    g=$(( 135 + (185 - 135) * t / 1000 ))
                    b=$(( 110 + (50  - 110) * t / 1000 ))
                    ;;
                nebula)
                    r=$(( 150 + (230 - 150) * t / 1000 ))
                    g=$(( 50  + (90  - 50)  * t / 1000 ))
                    b=$(( 235 + (255 - 235) * t / 1000 ))
                    ;;
                cyberlime|toxic)
                    r=$(( 190 + (50  - 190) * t / 1000 ))
                    g=$(( 255 + (255 - 255) * t / 1000 ))
                    b=$(( 10  + (160 - 10)  * t / 1000 ))
                    ;;
                lavender)
                    r=$(( 185 + (145 - 185) * t / 1000 ))
                    g=$(( 150 + (175 - 150) * t / 1000 ))
                    b=$(( 245 + (255 - 245) * t / 1000 ))
                    ;;
                autumn)
                    r=$(( 235 + (215 - 235) * t / 1000 ))
                    g=$(( 90  + (155 - 90)  * t / 1000 ))
                    b=$(( 20  + (10  - 20)  * t / 1000 ))
                    ;;
                load|*)
